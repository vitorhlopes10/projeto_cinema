...
public class IndicacaoViewController extends javax.swing.JFrame {

    IndicacaoRepository indicacaoRepository; 
    
    public IndicacaoViewController() throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Manter Indicação", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(0, 102, 255))); // NOI18N
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        try {
            if (txtNome.getText().equals("")) {
                ...
                indicacao.setNome(txtNome.getText());

                if (indicacaoRepository.Insert(indicacao)) {
                    LimparCampos();
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        try {
            if (txtNome.getText().equals("")) {
                ...
                Indicacao indicacao = new Indicacao();
                indicacao.setNome(txtNome.getText());
                indicacao.setId(Integer.parseInt(txtId.getText()));

                if (indicacaoRepository.Update(indicacao)) {
                    LimparCampos();
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        try {
            if (txtId.getText().equals("")) {
                ...
                if (indicacaoRepository.Delete(indicacao.getId())) {
                    LimparCampos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IndicacaoViewController.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new IndicacaoViewController().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(IndicacaoViewController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    public void PopularGrid() throws SQLException {
        try {
            ...
            Indicacao indicacao = new Indicacao();
            ArrayList<Indicacao> listIndicacoes = new ArrayList<Indicacao>();
            listIndicacoes = indicacaoRepository.List();

            for (int i = 0; i < listIndicacoes.size(); i++) {
                indicacao = listIndicacoes.get(i);
                colunas[0] = indicacao.getId();
                colunas[1] = indicacao.getNome();
